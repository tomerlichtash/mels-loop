...
53. ההוראות במחשבת ה-RPC-4000 כללו בדיוק 13 ביטים שהכילו את כתובת המידע בזיכרון. מכאן, שהכתובת הגבוהה ביותר אליה ניתן היה לפנות, הייתה המספר הגדול ביותר שניתן לייצג ב-13 ביטים (מנגנון ההיסט לא רלוונטי בעניין הזה).
...
56. הוֹרָאַת דִּלּוּג (Jump Instruction): דילוג מהכתובת בזיכרון בה נמצא המחשב לכתובת המצורפת בהוראת הדילוג. כתובת זו אינה בהכרח סמוכה לכתובת הנוכחית שבה נמצא המחשב, או לכתובת האחרונה שנקראה. כפי שמפורט בהערה 55, ייתכן שזכרונו של ניית'ר לא שימר את החלק הזה נאמנה. הסבר מפורט תוכלו למצוא במאמרים הנלווים.
