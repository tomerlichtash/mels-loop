...
ומחשבים אמיתיים[(#real-computers)] נבנו ב[תופים](#drum-memory) וב[שפופרות](#vaccum-tube),
מתכנתים אמיתיים כתבו ב[שפת מכונה](#assembly-language).
לא [פוֹרְטְרַן](#fortran). לא [ראטפוֹר](#ratfor). אפילו לא [שפת סף](#).
שפת מכונה.
מספרים גולמיים ויפים ב[בסיס הקסדצימלי](#hexadecimal).
ישירות.
...
החברה ייצרה אז את ה-[30-LGP](#lgp-30),
מחשב קטן וזול (בסטנדרטים של היום)
בעל [זיכרון תוף](#drum-memory),
ובדיוק החלה בייצור
ה-[4000-RPC](#rpc-4000), מחשב מתקדם יותר,
גדול יותר, טוב יותר, מהיר יותר – בעל [זיכרון תוף](#drum-memory).
[ליבּוֹת זיכרון](#magnetic-core-memory) היו יקרות מדי,
ובכל אופן, עמדו להעלם.
(זו הסיבה שלא שמעת על החברה,
או על המחשב.)

נשׂכרתי לכתוב [מְהַדֵּר](#compiler) [פוֹרְטְרַן](#fortran)
...
במספרים [הקסדצימליים](#hexadecimal),
...
(מי בכלל ידע אז מה זה [פּוֹרְט](#port)?)
[מִיעוּן הכְּתוֹבוֹת](#addressing-scheme)[(#instruction1)] במחשב החדש
היה מסוג אחד-ועוד-אחד
כך שבכל הוראה למכונה,
בנוסף ל[קוד-הפעולה](#operation-code)
ולכתובת ה[אוֹפֵּרַנְדּ](#operand),
היתה כתובת נוספת שציינה היכן, על התוף המסתובב,
ממוקמת ההוראה הבאה.

בהשאלה לימינו,
כל פעולה הסתיימה בפקודה [GO TO](#goto)!
פַּטְמוּ בַּזֶּה את מיקטרתו של [פסקל](#pascal) ועשנו.

מל אהב את ה-4000-RPC
משום שידע לכתוב עבורו [קוד אופטימלי](#optimal-code):
כלומר, למקם הוראות על התוף
כך, כאשר הוראה נשלמה,
הבאה כבר הגיעה אל "הראש הקורא"
נגישה ליישום מיידי.
הייתה תוכנה שנועדה לעשות את הדבר הזה בדיוק,
"[אָסֶמְבְּלֶר](#assembly-language) מייעל",[(#ref1)]
...
עם קוד זהה שעבר עיסוי ב[אָסֶמְבְּלֶר](#assembly-language) המייעל,
הקוד של מל תמיד רץ מהר יותר.
זה היה משום ש[עיצוב המעלה-מטה](#top-down-design)
עוד לא הומצא אז
...
מל מעולם גם לא כתב [לולאות השהיה](#time-delay-loop),
אפילו כשה[פְלֵקסוֹרַייטֵר](#friden-flexowriter) העיקש
...
שגור בדיבור:
"לא לגמרי [אופטימום](#optimum)" או "פחות [אופטימום](#optimum)"
או "לא ממש [אופטימום](#optimum)".
מל כינה את אזורי ההשהיה המקסימלית
"[פסימום](#pessimum) קיצוני".
...
[לולאה](#loop) תמימה ללא [תנאי עצירה](#terminating-condition).
שום תנאי. כלום.
...
בשם [אוֹגֵר](#register)-מוֹנֶה
שאיפשר לתכנת לולאות
שעושות שימוש בהוראות עם היסט
בכל ריצה של הלולאה
המספר ב[אוֹגֵר](#register)-מונה
התווסף לכתובת האופרנד בהוראה
כדי להצביע על
פיסת המידע הבאה בסדרה.
המתכנת היה צריך רק להוסיף 1 לערך השמור ב[אוֹגֵר](#register)[(#index-register-1)]
בכל מעבר דרך הלולאה.
מל מעולם לא השתמש בו.

תחת זאת, הוא העתיק את ההוראה אל [אוֹגֵר](#register) אחר במכונה
הוסיף 1 לרכיב הכתובת
ושמר את התוצאה במקומה המקורי בזכרון.[(#index-register-2)]
אז הריץ את ההוראה העדכנית
ישר מן ה[אוֹגֵר](#register).
...
שה[ביט](#bit) של ה[אוֹגֵר](#register)-מונה,
ה[ביט](#bit) שבין הכתובת לבין קוד-הפעולה בהוראה,
היה דלוק[(#bit-binary-note)] –
אך מל לא השתמש ב[אוֹגֵר](#register)-מונה,
