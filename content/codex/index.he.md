...
מאמר מן הזמן האחרון על צד _מצ'ואיסטי_ בתכנות[(#note1)]
יצא בהכרזה נועזת וחסרת בסיס:

> "[מתכנתים אמיתיים](#) כותבים ב[פוֹרְטְרַן](#)"

אולי כיום,
בתקופה דקדנטית זו של
בירה לייט, מחשבוני כיס[(#note4)], ותוכנה ["ידידותית-למשתמש"](#)[(#note5)]
אך בימים ההם[(#note6)],
כשהמונח "תוכנה" עוד היה נשמע מצחיק,
ומחשבים אמיתיים[(#note7)] נבנו ב[תופים](#) וב[שפופרות](#),
...
אקרא לו מֵל,
כי זה היה שמו.[(#note14)]

את מל פגשתי כשעבדתי בחברת המחשבים רוֹיאל-מֶק'בִּי[(#note15)],
כיום ישות רפאים עסקית המייצרת מכונת כתיבה.[(#note16)]
...
עבור הפֶּלא[(#note21)] החדש הזה ומל היה המדריך שלי לכל נפלאותיו.
מל תיעב מהדרים.
...
עם לקוחות פוטנציאליים.[(#note23)]
התגובות שעוררה תמיד היו דרמטיות.[(#note24)]
בכל תערוכה היה ביתן ה-30-LGP עמוס,[(#note25)]
סביב התגודדו אנשי המכירות של IBM
ודיברו ביניהם.[(#note26)]
אם כל זה מכר מחשבים או לא
זו היתה שאלה שמעולם לא שאלנו.

העבודה של מל היתה לשכתב
את תוכנת הבלאק ג'ק עבור ה-4000-RPC.[(#note27)]
(מי בכלל ידע אז מה זה [פּוֹרְט](#)?)
[מִיעוּן הכְּתוֹבוֹת](#)[(#note30)] במחשב החדש
...
המתכנת היה צריך רק להוסיף 1 לערך השמור ב[אוֹגֵר](#)[(#note49)]
בכל מעבר דרך הלולאה.
מל מעולם לא השתמש בו.

תחת זאת, הוא העתיק את ההוראה אל [אוֹגֵר](#) אחר במכונה
הוסיף 1 לרכיב הכתובת
ושמר את התוצאה במקומה המקורי בזכרון. <!-- TODO: FIX TRANSLATION and ADD COMMMENT #50 -->
...
סמוך לראש הזיכרון –
בכתובות הגדולות ביותר אליהן יכלה הוראה לפנות[(#note53)] -
כך שלאחר שפריט המידע האחרונה טופל,
פעולת חיבור על כתובת ההוראה
הייתה גורמת לגלישתה.[(#note54)]
העברת השארית הוסיפה אחד <!-- TODO: REVISE COMMENT #55 -->
