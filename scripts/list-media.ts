...
import { ListObjectsV2Command, ListObjectsV2CommandOutput,
	_Object as S3Object } from "@aws-sdk/client-s3";
...
listObjects().then((response: ListObjectsV2CommandOutput) => {
	console.log("List response", response.Contents?.map(o => ({
		name: o.Key,
