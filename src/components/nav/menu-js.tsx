...
const ViewportPosition = React.forwardRef<
	React.ElementRef<typeof React.ReactHTMLElement>,
	React.ComponentProps<typeof React.ReactHTMLElement>
>((props, forwardedRef) => {
	const { ...itemProps } = props;
	return (
		<div {...itemProps} ref={forwardedRef} className={classes.viewportPosition}>
			{/* {props.children} */}
		</div>
	);
});
