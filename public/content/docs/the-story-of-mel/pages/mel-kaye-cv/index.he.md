...
- [**הסיפור על מל** (גרסת מוערת בדף הבית של לולאת מל)](/)
- [**מבוא לסיפור על מל: על אגדת תוכנה שקרתה באמת**](/docs/the-story-of-mel/pages/preface)
- [**לולאת מל – הביטים הנעדרים**](/docs/the-story-of-mel/pages/mels-hack-the-missing-bits)
